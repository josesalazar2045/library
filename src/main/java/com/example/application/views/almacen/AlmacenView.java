...
@PageTitle("Almacen")
@Route(value = "Almacen/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
public class AlmacenView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "Almacen/%s/edit";
    ...
    public AlmacenView(SampleBookService sampleBookService) {
